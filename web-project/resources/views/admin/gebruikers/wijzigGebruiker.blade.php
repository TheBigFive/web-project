        ...
        <h2>Wijziging gebruiker</h2>      
        		...
        		<form action="/admin/gebruikers/wijzig/{{ $geopendeGebruiker->id }}" method="post">
	             	...
	             	<div class="row">
		                <div class="col-md-6">
			                ...
			                <div class="form-group{{ $errors->has('studentenclub') ? ' has-error' : '' }}">
			                    ...
			                    <input type="text" class="form-control" value="{{ $geopendeGebruiker->studentenclub }}" name="studentenclub" placeholder="Typ hier de naam van je studentenclub">
	                ...
	                <div class="row">
		                ...
		                <span>
		                	<a href="/admin/gebruikers/verwijder/{{ $geopendeGebruiker->id }}" class="btn btn-red">Account verwijderen</a>
		             	</span>	
